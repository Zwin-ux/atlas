...
// Host payload watch-item (NS-6): the ~780KB _meta.generatedDraftScene vs
// the real ChatGPT host transport budget. The exact host ceiling for iframe
// payloads is unconfirmed (150k chars is the MODEL-text budget), so this
// ships as a REPORTING threshold, env/param-overridable, not a hard fail.
