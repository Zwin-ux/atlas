...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| autauga-al | 1 | metro_grid | desktop | light | pass: state=delivered; errors=0 | pass: graphics=693; ceiling=1600 | pass: max generatedDraftSceneChars=789550; ceiling=900000 | pass: console error entries=0 |
