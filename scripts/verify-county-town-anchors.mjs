...
try {
  ...
  check(index.method.maximumAnchorsPerCounty === 40, "anchor budget is 40 towns per county");
  check(index.totals.anchorCount === 21_155, "the certified index contains 21,155 anchors");
