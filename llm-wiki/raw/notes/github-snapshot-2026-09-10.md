# GitHub snapshot 2026-09-10

Owner asked to push Atlas work so ChatGPT can read it, organize the trees,
...
Secrets: `.env` / `.env.local` stay gitignored. `ready.json` is local runtime
